...
public class MainActivity extends AppCompatActivity {
    ...
    TextView welcomeText, tasksDueTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tasksDueTextView = findViewById(R.id.tasksDueTextView);
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(document != null){
                        ...
                        //set text view to notify how many tasks are due
                        String listSize = String.valueOf(interestsList.size());
                        if(interestsList.size() == 1){
                            String tasksDueText = "You have " + listSize + " task due";
                            tasksDueTextView.setText(tasksDueText);
                        }else{
                            String tasksDueText = "You have " + listSize + " tasks due";
                            tasksDueTextView.setText(tasksDueText);
                        }
